...
import 'package:flutter_mfw/pages/other/detail/user_strategy_detail.dart';
...
class UserStrategyList extends StatefulWidget {
  var id;
...
//  话题标签，只有点击推荐栏目的时候会查询出所有的话题标签
  ...
  @override
  _UserStrategyListState createState() => _UserStrategyListState();
}

class _UserStrategyListState extends State<UserStrategyList>
  ...
  void _getWaterFallData() {
    var url = 'strategy/fiindValugByIdUserId';
    var query = {'puhlishid': widget.strId, 'pageNum': 1, 'pageSize': 1000};
    Http.patchData(
        url,
        (result) {
          // print(result);
