  ...
  Widget _itemWidget(HoteItemModel itemModel) {
    return GestureDetector(
      onTap: () {
        ...
        Navigator.of(context).pushNamed("/topic_content_widget",arguments: {"id":123,"tagName":itemModel.title});
      },
      child: Container(
          alignment: Alignment.center,
          margin: EdgeInsets.fromLTRB(0, 3, 6, 5),
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: Text(
                  "露宿野餐",
                  style: TextStyle(
                      color: Color(0xFF909399), fontWeight: FontWeight.bold),
                ),
              )
            ],
          )),
