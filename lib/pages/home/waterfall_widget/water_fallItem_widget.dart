...
class _WaterfallItemWidgetState extends State<WaterfallItemWidget> {
  ...
  Widget build(BuildContext context) {
    var imageURL = widget.item['imgs'][0];
    return Card(
            ...
            children: <Widget>[
              ...
              Row(
                  children: <Widget>[
                   GestureDetector(
                     onTap: (){
                       JhToast.showInfo(context,msg: '点赞${widget.item['author']}');
                     },
                     child:  Icon(Icons.favorite_border,color: Color.fromRGBO(122, 133, 147, 1.0),size: 14),
                   ),
                    Text("${widget.item['startnum']}",
                        style: TextStyle(
                            fontSize: 12,
