...
class TravelDetailWidget extends StatefulWidget {
  var animation = false;
  TravelDetailWidget({Key key, this.animation, this.param}) : super(key: key);
    ...
    return Scaffold(
        ...
        body: Stack(
          children: <Widget>[
            // 底部nav
            WebView(
              initialUrl: 'http://192.168.43.98:8082/#/strategyDetail/' +
                  widget.param['_id'], //动态查询
              // 加载的网页
        ...
        */
            ...
            Positioned(
              ...
              child: DetailBottomBarWidget(
                ...
                startNum: widget.param['startnum'],
                isLove: isSttart,
                isColect: isColect,
                collectNum: collist.length,
              ),
            )
          ],
        ));
                ...
                onTap: () async {
                  if (index == 0) {
                    ...
                    await fluwx.share(fluwx.WeChatShareWebPageModel(
                        webPage: 'http://192.168.43.98:8082/#/strategyDetail/' +
                            widget.param['_id'],
                        transaction: 'hehe',
                        title: '随心游分享',
